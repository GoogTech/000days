...
LastEditTime: 2020-09-19 20:05:30
...
coverTemplatePath = os.getcwd() + "\\coverTemplate.md";
coverPicDownloadPath = os.getcwd() + "\\coverPicDownload"

# 打开博客封面图的模板文件
fo = open(coverTemplatePath, "r+", encoding='UTF-8')
# 读取文件内容
text = fo.read()
# 查看文件内容
print(text)
...
url = "https://carbon.now.sh/?bg=rgba(126%2C211%2C33%2C1)&t=one-light" \
...
print('ok: new file name: ' + fileList[-1] + " and created time: " + updateTime.strftime("%Y-%m-%d %H-%M-%S"))

# 移动文件
shutil.move(chromeFileDir + fileList[-1], coverPicDownloadPath)
